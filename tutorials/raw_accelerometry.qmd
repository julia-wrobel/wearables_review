...
Then we can run the model, using the SSL model type. We have to include the sample rate as well. Since the method does it's own gravity calibration, we use the uncalibrated dataset.  
